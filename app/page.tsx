  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="container mx-auto px-6 py-6 flex-1">
        ...
        {/* Demo Data Notice */}
        <div className="mb-6 flex items-start gap-2 rounded-lg border-2 border-amber-400 bg-amber-400 px-4 py-3 text-sm font-medium text-white shadow-sm">
          <svg className="mt-0.5 h-4 w-4 flex-shrink-0 text-white" fill="currentColor" viewBox="0 0 20 20">

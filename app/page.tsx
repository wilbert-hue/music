  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="container mx-auto px-6 py-6 flex-1">
        ...
        {/* Demo Data Notice */}
        <div
          className="mb-6 flex items-center gap-2 rounded px-4 py-3 text-sm"
          style={{ backgroundColor: '#fffbeb', border: '1px solid #fcd34d', color: '#78350f' }}
        >
          <svg className="h-4 w-4 flex-shrink-0" style={{ color: '#f59e0b' }} fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M8.485 2.495c.673-1.167 2.357-1.167 3.03 0l6.28 10.875c.673 1.167-.17 2.625-1.516 2.625H3.72c-1.347 0-2.189-1.458-1.515-2.625L8.485 2.495zM10 5a.75.75 0 01.75.75v3.5a.75.75 0 01-1.5 0v-3.5A.75.75 0 0110 5zm0 9a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
          </svg>
          <span>
            <strong style={{ color: '#d97706' }}>NOTE: </strong>All the data in the dashboard is demo data. No real world data is related to this.
          </span>
        </div>
